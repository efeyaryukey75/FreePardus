/*
 *   Copyright 2020 efeyaryukey <muhammedfaruk@protonmail.com
 *
    ...
    */
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            textColor: "#000000"
            selectedTextColor: "#204d71"        // The highlighted text color
            selectionColor: "#7c8eb6"           // The text highlight color
            placeholderTextColor:"#FFFFFF"      // When the text field is empty
            background: Rectangle {
                color: "#FFFFFF"
                radius: 2
                                                    //focus   //normal
                border.color: control.activeFocus ? "#7c8eb6" : '#204d71'
                border.width: 1
                implicitWidth: 100
                implicitHeight: 30
            }
    ...
    PlasmaComponents.TextField {
        ...
        style: TextFieldStyle {
            ...
            selectedTextColor: "#204d71"        // The highlighted text color
            selectionColor: "#7c8eb6"           // The text highlight color
            placeholderTextColor:"#7c8eb6"      // When the text field is empty
            background: Rectangle {
                color: "#FFFFFF"
                radius: 2
                                                    //focus   //normal
    ...
    PlasmaComponents.Button {
        ...
        style: ButtonStyle {
            background: Rectangle {
                border.width: 1
                                                    //focus   //normal
                border.color: control.activeFocus ? "#7c8eb6" : "#93a8d8"
                radius: 2
                gradient: Gradient {                                      //pressed   //normal
                    GradientStop { position: 0 ; color: control.pressed ? "#7c8eb6" : "#93a8d8" }
                    GradientStop { position: 1 ; color: control.pressed ? "#7c8eb6" : "#93a8d8" }
                }
                //implicitWidth: 100
                implicitHeight: 30
            }
